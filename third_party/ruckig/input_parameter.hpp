...
public:
    ...
    nonstd::optional<std::vector<Vector<double>>> per_section_max_velocity, per_section_max_acceleration, per_section_max_jerk;
    nonstd::optional<std::vector<Vector<double>>> per_section_min_velocity, per_section_min_acceleration;
    nonstd::optional<std::vector<Vector<double>>> per_section_max_position, per_section_min_position;
    ...
    nonstd::optional<std::vector<double>> per_section_minimum_duration;
